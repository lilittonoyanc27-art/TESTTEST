  ...
  const handleAIFeedback = () => {
    ...
    setTimeout(() => {
      ...
      if (lang === 'arm') {
        ...
        if (draft.includes("yo vivir") || draft.includes("mi vivir") || draft.includes("yo gustar")) {
          feedback += "⚠️ *Грамматика:* Вы использовали инфинитив глагола (vivir/gustar). В испанском языке глаголы нужно спрягать лично. Пишите: «Yo vivo» (я живу) или «Me gusta» (мне нравится).\n\n";
        }
        if (draft.includes("en mi casa hay") || draft.includes("en mi piso hay")) {
                      ...
                      <div className="space-y-3">
                        {q.options.map((opt, optIdx) => {
                          ...
                          if (hasAnswered) {
                            if (isSelected) {
                              if (isCorrectOpt) {
                                // Correct Selection (Green circular radio)
                                ...
                                // Incorrect Selection (Pink/Red circular radio)
                              ...
                              // Not chosen but is the actual correct answer - highlight subtle green
                              optionClass = "border-emerald-200 bg-emerald-50/20 text-emerald-700";
                              circleClass = "border-emerald-300";
                            } else {
                              // Unselected wrong answer after answer submitted
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-3">
                                {/* Round radio styled matching screen markup */}
